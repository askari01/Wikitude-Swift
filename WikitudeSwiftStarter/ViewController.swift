...
//        }
        ...
        do {
            try WTArchitectView.isDeviceSupported(forRequiredFeatures: WTFeatures._Geo)
            architectView = WTArchitectView(frame: self.view.frame)
            architectView?.delegate = self
            architectView?.setLicenseKey("")
            
            
            self.architectView?.loadArchitectWorld(from: Bundle.main.url(forResource: "index", withExtension: "html", subdirectory: "ArchitectWorld"), withRequiredFeatures: WTFeatures._Geo)
            self.view.addSubview(architectView!)
